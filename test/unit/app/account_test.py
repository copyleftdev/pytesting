...
from app.account import Account, ConnectionError


class TestAccount(unittest.TestCase):
  def test_account_returns_for_id_1(self):
    ...
    def test_account_when_connection_exception_raised(self):
      mock_data_interface = Mock()
    ...
    @patch('app.account.requests') #pragma: no cover
